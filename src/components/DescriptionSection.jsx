...
export default function DescriptionSection() {
    ...
    return (
        <section ref={sectionRef} className="w-[min(1200px,95%)] min-h-page mx-auto flex max-lg:flex-col justify-center items-center gap-x-8 gap-y-16 max-lg:pb-32 overflow-hidden">
